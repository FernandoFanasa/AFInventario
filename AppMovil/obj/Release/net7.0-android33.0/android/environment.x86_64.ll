...
@__app_environment_variables_v_1.3 = internal constant [37 x i8] c"7a72f134-451c-4564-8735-91a6dfd6e19a\00", align 16
...
@__ApplicationConfig_android_package_name.0 = internal constant [25 x i8] c"com.devjair.AFinventario\00", align 16
...
@application_config = local_unnamed_addr constant %struct.ApplicationConfig {
	...
	i32 33564141, ; android_runtime_jnienv_class_token
	i32 100790465, ; jnienv_initialize_method_token
	i32 100790464, ; jnienv_registerjninatives_method_token
...
@__DSOCacheEntry_name.2 = internal constant [32 x i8] c"libimage_processing_util_jni.so\00", align 16
...
@dso_cache = local_unnamed_addr global [24 x %struct.DSOCacheEntry] [
	...
	%struct.DSOCacheEntry {
		...
		i8 0, ; ignore
		i8* getelementptr inbounds ([32 x i8], [32 x i8]* @__DSOCacheEntry_name.2, i32 0, i32 0), ; name
		i8* null; handle
	}, 
	; 2
	%struct.DSOCacheEntry {
...
@assembly_store_bundled_assemblies = local_unnamed_addr global [102 x %struct.AssemblyStoreSingleAssemblyRuntimeData] zeroinitializer, align 16
